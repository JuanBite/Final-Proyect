...
<div x-data="appData()" x-init="init()">
    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 mb-10">
        ...
        <div class="bg-[#1C2A40] border border-[#00C853]/15 rounded-2xl px-4 py-4 flex items-center gap-3 hover:-translate-y-0.5 hover:border-[#00C853]/35 hover:shadow-2xl transition-all cursor-default">
            <div class="w-10 h-10 rounded-xl bg-yellow-400/15 text-yellow-400 flex items-center justify-center shrink-0">
                <svg class="w-5 h-5" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24"><path d="M14 2H6a2 2 0 00-2 2v16a2 2 0 002 2h12a2 2 0 002-2V8z"/><polyline points="14 2 14 8 20 8"/><line x1="16" y1="13" x2="8" y2="13"/><line x1="16" y1="17" x2="8" y2="17"/></svg>
            </div>
            <div>
            ...
            <div class="flex items-center gap-2 flex-wrap">
                ...
                <div class="flex gap-1.5">
                    <template x-for="t in tabs" :key="t.key">
                        <button @click="window.location.href='?tab=' + t.key"
            ...
            <table class="w-full border-collapse min-w-[600px]">
                ...
                <tbody>
                    ...
                    @if($tab === 'regions')
                        ...
                        @empty
                        <tr><td colspan="3" class="text-center py-10 text-slate-500 text-sm">Sin registros. Agrega el primero.</td></tr>
                        @endforelse
                    @endif
    ...
    <div x-show="deleteModal"
         x-transition
         @click.away="deleteModal=false; document.body.style.overflow=''"
