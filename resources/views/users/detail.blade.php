...
@section('content')
<div x-data="{ editModalOpen: false, currentUserId: null }" x-init="   
    ...
    <div class="bg-[#1C2A40] border border-[#00C853]/15 rounded-2xl overflow-hidden hover:border-[#00C853]/35 hover:shadow-2xl hover:shadow-black/30 transition-all relative">
        ...
        <div class="px-8 pb-7 flex items-end gap-6 -mt-9 relative z-10">
            ...
            <div class="flex gap-2 pt-12 shrink-0">
                <button<button @click="editModalOpen = true; currentUserId = 1; document.body.style.overflow='hidden'" class="inline-flex items-center gap-1.5 px-4 py-2 rounded-xl text-sm font-medium bg-[#182236] text-slate-400 border border-[#00C853]/20 hover:text-slate-100 hover:border-[#00C853]/40 cursor-pointer transition-all">
