            ...
            <div>
                ...
                <div class="grid grid-cols-2 gap-4">
                    <div class="col-span-2 flex flex-col gap-1.5">
                        ...
                        <input class="form-input bg-[#182236] border border-[#00C853]/15 rounded-xl px-3.5 py-[11px] text-[#E8F4FF] text-[13.5px] w-full transition-all" type="text" placeholder="Ej: Sigpro Académico" />
                    </div>
                    <div class="col-span-2 flex flex-col gap-1.5">
                        <label class="text-[11px] uppercase tracking-[1px] text-[#8AAABB] font-medium">Descripción</label>
                        <textarea class="form-input bg-[#182236] border border-[#00C853]/15 rounded-xl px-3.5 py-[11px] text-[#E8F4FF] text-[13.5px] w-full resize-y min-h-[80px] leading-relaxed transition-all" placeholder="Describe brevemente el objetivo del proyecto..."></textarea>
                    </div>
                    <div class="flex flex-col gap-1.5">
                        ...
                        <input class="form-input bg-[#182236] border border-[#00C853]/15 rounded-xl px-3.5 py-[11px] text-[#E8F4FF] text-[13.5px] w-full transition-all" type="date" value="2026-03-13" />
                    </div>
                    <div class="flex flex-col gap-1.5">
                        <label class="text-[11px] uppercase tracking-[1px] text-[#8AAABB] font-medium">Fecha entrega <span class="text-[#00C853]">*</span></label>
                        <input class="form-input bg-[#182236] border border-[#00C853]/15 rounded-xl px-3.5 py-[11px] text-[#E8F4FF] text-[13.5px] w-full transition-all" type="date" />
                    </div>
                </div>
            </div>
            ...
            <div>
                ...
                <div class="flex flex-col gap-1.5">
                    ...
                    <div class="flex items-center gap-3">
                        <input class="form-input bg-[#182236] border border-[#00C853]/15 rounded-xl px-3.5 py-[11px] text-[#E8F4FF] text-[13.5px] text-center w-20 shrink-0 transition-all" type="number" min="0" max="100" value="0" id="pctInput" oninput="document.getElementById('pbar').style.width=Math.min(100,Math.max(0,this.value))+'%'" />
