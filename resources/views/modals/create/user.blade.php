    ...
    <div class="grid grid-cols-3 gap-3">
        ...
        <div @click="selectedRole = 'INSTRUCTOR'"
            ...
            <div class="flex justify-center mb-1.5">
                <svg class="w-6 h-6 text-[#00C853]" fill="none" stroke="currentColor" stroke-width="1.8" viewBox="0 0 24 24">
        ...
        <div @click="selectedRole = 'STUDENT'"
            ...
            class="rounded-xl p-3.5 cursor-pointer text-center border transition-all">
            <div class="flex justify-center mb-1.5">
                <svg class="w-6 h-6 text-[#40C4FF]" fill="none" stroke="currentColor" stroke-width="1.8" viewBox="0 0 24 24">
        ...
        <div @click="selectedRole = 'ADMIN'"
            ...
            class="rounded-xl p-3.5 cursor-pointer text-center border transition-all">
            <div class="flex justify-center mb-1.5">
                <svg class="w-6 h-6 text-[#FFD740]" fill="none" stroke="currentColor" stroke-width="1.8" viewBox="0 0 24 24">
    ...
    <div class="flex flex-col gap-2">
        ...
        <div class="relative" x-data="{ open: false, search: '' }" @click.outside="open = false">
            ...
            <div @click="open = true"
                ...
                <svg class="w-3.5 h-3.5 text-[#8AAABB] shrink-0" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24">
                ...
                <svg class="w-3.5 h-3.5 text-[#8AAABB] shrink-0 transition-transform" :class="open ? 'rotate-180' : ''" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24">
            ...
            <div x-show="open" x-transition
                ...
                <!-- Lista filtrada -->
                <div class="max-h-48 overflow-y-auto [&::-webkit-scrollbar]:w-1.5 [&::-webkit-scrollbar-track]:bg-[#0d1726] [&::-webkit-scrollbar-thumb]:bg-[#2a3a52] [&::-webkit-scrollbar-thumb]:rounded-full">
                    <template x-for="project in projects.filter(p => p.name.toLowerCase().includes(search.toLowerCase()) && !selected.includes(p.id))" :key="project.id">
        ...
        <div class="flex flex-wrap gap-2 mt-2">
            <template x-for="project in selectedProjects" :key="project.id">
                <div class="flex items-center gap-2 px-3 py-1.5 rounded-xl bg-[#182236] border border-[#00C853]/15">
                    ...
                    <button type="button" @click="removeProject(project.id)" class="ml-2 text-red-400 hover:text-red-600">
