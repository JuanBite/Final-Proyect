                ...
                <form method="POST" action="{{ route('login') }}">
                    ...
                    <div class="mb-5">
                        ...
                        <div class="relative">
                            ...
                            <input type="email" name="email" placeholder="usuario@correo.com" value="{{ old('email') }}" class="w-full pl-10 pr-4 py-3 rounded-lg bg-white/5 border border-white/10 focus:border-green-400 outline-none text-sm text-gray-200 placeholder-gray-600 transition">
                        </div>
                    ...
                    <div class="mb-6">
                        ...
                        <div class="relative">
                            ...
                            <input type="password" id="password" name="password" placeholder="••••••••" class="w-full pl-10 pr-10 py-3 rounded-lg bg-white/5 border border-white/10 focus:border-green-400 outline-none text-sm text-gray-200 placeholder-gray-600 transition">
