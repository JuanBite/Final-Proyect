    ...
    <div class="flex flex-col items-center justify-center p-6 bg-[#07121c]">
        ...
        <div class="w-full max-w-md">
            ...
            <div class="flex gap-3 mb-7">
                <!-- Líder (selected) -->
                <button class="flex-1 flex items-center gap-3 py-3 px-4 rounded-xl bg-green-500/10 border border-green-500 text-left transition">
                    ...
                    <div>
                        <p class="text-green-400 font-semibold text-sm">Líder</p>
                        <p class="text-gray-500 text-xs">Gestión completa</p>
                    </div>
                </button>

                <!-- Miembro -->
                <button class="flex-1 flex items-center gap-3 py-3 px-4 rounded-xl bg-white/5 border border-white/10 text-left transition hover:border-white/20">
                    ...
                    <div>
                        <p class="text-gray-300 font-semibold text-sm">Miembro</p>
