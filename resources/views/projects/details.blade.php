...
<div class="bg-[#1C2A40] border border-[#00C853]/15 rounded-2xl overflow-hidden hover:border-[#00C853]/35 hover:shadow-2xl hover:shadow-black/30 relative transition-all">
    ...
    <div class="flex items-start justify-between mb-6 relative z-10 px-8 py-7">
        ...
        <div class="flex gap-2 shrink-0">
            <button class="inline-flex items-center gap-1.5 px-4 py-2 rounded-xl text-sm font-medium bg-slate-800 text-slate-400 border border-emerald-500/20 hover:text-slate-100 hover:border-emerald-500/40 cursor-pointer transition-all">
            ...
            <button class="inline-flex items-center gap-1.5 px-4 py-2 rounded-xl text-sm font-medium bg-red-500 text-slate-900 hover:bg-red-400 hover:-translate-y-px cursor-pointer transition-all shadow-lg shadow-red-500/30">
...
<!-- Toast -->
<div id="toast" class="fixed bottom-6 right-6 flex items-center gap-2.5 bg-[#1C2A40] border border-[#00C853]/30 rounded-xl px-4 py-3 text-sm shadow-2xl z-50 translate-y-20 opacity-0 transition-all duration-300 pointer-events-none">
