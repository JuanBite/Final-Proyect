...
<a href="{{ url('projects') }}" class="text-[11px] uppercase tracking-[1.5px] text-[#8AAABB] hover:text-[#00C853] transition-colors">
    Proyectos
</a>
<span class="text-[#00C853]/30">›</span>
            ...
            <div class="flex items-center gap-4">
                ...
                <div>
                    ...
                    <div class="flex gap-2 mt-2.5 flex-wrap">
                        ...
                        <span class="px-3 py-0.5 rounded-full text-xs font-medium bg-yellow-400/15 text-yellow-400 border border-yellow-400/30">{{
        ...
        <div class="overflow-x-auto">
            <table class="border-collapse w-full">
                ...
                <tbody>
                    ...
                    <tr>
                        <td rowspan="10" class="text-emerald-400 font-bold text-[10px] tracking-[2px] text-center px-1.5 border-r-2 border-r-emerald-500/30 border border-[#2b2b2b] align-middle select-none" style="writing-mode:vertical-rl;text-orientation:mixed;transform:rotate(180deg);font-family:Syne,sans-serif;background:#0e1a2d">
                            INVESTIGACIÓN</td>
                        ...
                        <td class="border border-[#2b2b2b] text-center" style="background:#1a2740"><span class="text-slate-400 text-xs">7/12/2023</span></td>
                        <td class="border border-[#2b2b2b] text-center" style="background:#1a2740"><span class="inline-block w-3.5 h-3.5 rounded-sm bg-blue-700/80 border border-blue-600/40"></span>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td class="border border-[#2b2b2b] text-center" style="background:#172337"><span class="inline-block w-3.5 h-3.5 rounded-sm bg-emerald-500/60 border border-emerald-400/30"></span>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td class="border border-[#2b2b2b] text-center" style="background:#1a2740"><span class="inline-block w-3.5 h-3.5 rounded-sm bg-emerald-500/60 border border-emerald-400/30"></span>
                        </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td class="border border-[#2b2b2b] text-center" style="background:#172337"><span class="text-slate-400 text-xs">7/08/2023</span></td>
                        <td class="border border-[#2b2b2b] text-center" style="background:#172337"><span class="inline-block w-3.5 h-3.5 rounded-sm bg-blue-700/80 border border-blue-600/40"></span>
                        </td>
                    </tr>

                    <!-- CONSTRUCCIÓN DEL SOFTWARE - FASE 2 -->
                    <tr>
                        <td rowspan="12" class="text-emerald-400 font-bold text-[10px] tracking-[2px] text-center px-1.5 border-r-2 border-r-emerald-500/30 border border-[#2b2b2b] align-middle select-none" style="writing-mode:vertical-rl;text-orientation:mixed;transform:rotate(180deg);font-family:Syne,sans-serif;background:#0e1a2d">
