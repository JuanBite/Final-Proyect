...
<div x-data="{ modalEditarAbierto: false, modalEliminarAbierto: false }" class="flex flex-col gap-6">
        ...
        <div class="grid grid-cols-5 gap-5 relative z-10 px-8 pb-5">
            ...
            <div>
                ...
                <p class="text-sm font-medium">
                    {{ $project->leader?->first_name ?? 'Sin líder' }}
                ...
                <thead>
                    <tr>
                        ...
                        <th class="text-[10px] font-bold text-slate-300 border border-[#2b2b2b] text-center"
                            style="width:56px;min-width:56px;padding:10px 0;background:#0e1a2d">ESTADO</th>
                    </tr>
                </thead>
                <tbody>
                    ...
                    <tr>
                        <td rowspan="10"
                            ...
                            style="writing-mode:vertical-rl;text-orientation:mixed;transform:rotate(180deg);font-family:Syne,sans-serif;background:#0e1a2d">
                            INVESTIGACIÓN</td>
                        <td class="text-xs text-slate-200 px-3 py-2 border border-[#2b2b2b] leading-snug"
                            style="background:#1a2740">CONTEXTO DEL PROBLEMA</td>
                        <td class="border border-[#2b2b2b] text-center" style="background:#1a2740"><span
                                class="text-slate-400 text-xs">—</span></td>
                        <td class="border border-[#2b2b2b] text-center" style="background:#1a2740"><span
                                class="text-slate-400 text-xs">7/12/2023</span></td>
                        <td class="border border-[#2b2b2b] text-center" style="background:#1a2740"><span
                                class="text-slate-400 text-xs">7/12/2023</span></td>
                        <td class="border border-[#2b2b2b] text-center" style="background:#1a2740"><span
                                class="inline-block w-3.5 h-3.5 rounded-sm bg-blue-700/80 border border-blue-600/40"></span>
                        </td>
                    </tr>
                    <tr>
                        <td class="text-xs text-slate-200 px-3 py-2 border border-[#2b2b2b] leading-snug"
                            style="background:#172337">ÁRBOL DE PROBLEMAS</td>
                        <td class="border border-[#2b2b2b] text-center" style="background:#172337"><span
                                class="text-slate-400 text-xs">—</span></td>
                        <td class="border border-[#2b2b2b] text-center" style="background:#172337"><span
                                class="text-slate-400 text-xs">20/10/2023</span></td>
                        <td class="border border-[#2b2b2b] text-center" style="background:#172337"><span
                                class="text-slate-400 text-xs">15/12/2023</span></td>
                        <td class="border border-[#2b2b2b] text-center" style="background:#172337"><span
                                class="inline-block w-3.5 h-3.5 rounded-sm bg-emerald-500/60 border border-emerald-400/30"></span>
                        </td>
                    </tr>
                    <tr>
                        <td class="text-xs text-slate-200 px-3 py-2 border border-[#2b2b2b] leading-snug"
                            style="background:#1a2740">PLANTEAMIENTO DEL PROBLEMA</td>
                        <td class="border border-[#2b2b2b] text-center" style="background:#1a2740"><span
                                class="text-slate-400 text-xs">—</span></td>
                        <td class="border border-[#2b2b2b] text-center" style="background:#1a2740"><span
                                class="text-slate-400 text-xs">20/10/2023</span></td>
                    ...
                    <tr>
                        <td class="text-xs text-slate-200 px-3 py-2 border border-[#2b2b2b] leading-snug"
                            style="background:#172337">ÁRBOL DE OBJETIVOS</td>
                        <td class="border border-[#2b2b2b] text-center" style="background:#172337"><span
                                class="text-slate-400 text-xs">—</span></td>
                        <td class="border border-[#2b2b2b] text-center" style="background:#172337"><span
                                class="text-slate-400 text-xs">20/10/2023</span></td>
                    ...
                    <tr>
                        <td class="text-xs text-slate-200 px-3 py-2 border border-[#2b2b2b] leading-snug"
                            style="background:#1a2740">CADENA DE VALOR</td>
                        <td class="border border-[#2b2b2b] text-center" style="background:#1a2740"><span
                                class="text-slate-400 text-xs">—</span></td>
                        <td class="border border-[#2b2b2b] text-center" style="background:#1a2740"><span
                                class="text-slate-400 text-xs">20/10/2023</span></td>
                    ...
                    <tr>
                        <td class="text-xs text-slate-200 px-3 py-2 border border-[#2b2b2b] leading-snug"
                            style="background:#172337">ANTECEDENTES</td>
                        <td class="border border-[#2b2b2b] text-center" style="background:#172337"><span
                                class="text-slate-400 text-xs">—</span></td>
                        <td class="border border-[#2b2b2b] text-center" style="background:#172337"><span
                                class="text-slate-400 text-xs">20/10/2023</span></td>
                    ...
                    <tr>
                        <td class="text-xs text-slate-200 px-3 py-2 border border-[#2b2b2b] leading-snug"
                            style="background:#1a2740">JUSTIFICACIÓN</td>
                        <td class="border border-[#2b2b2b] text-center" style="background:#1a2740"><span
                                class="text-slate-400 text-xs">—</span></td>
                        <td class="border border-[#2b2b2b] text-center" style="background:#1a2740"><span
                                class="text-slate-400 text-xs">20/10/2023</span></td>
                    ...
                    <tr>
                        <td class="text-xs text-slate-200 px-3 py-2 border border-[#2b2b2b] leading-snug"
                            style="background:#172337">MARCO CONCEPTUAL</td>
                        <td class="border border-[#2b2b2b] text-center" style="background:#172337"><span
                                class="text-slate-400 text-xs">—</span></td>
                        <td class="border border-[#2b2b2b] text-center" style="background:#172337"><span
                                class="text-slate-400 text-xs">20/10/2023</span></td>
                    ...
                    <tr>
                        <td class="text-xs text-slate-200 px-3 py-2 border border-[#2b2b2b] leading-snug"
                            style="background:#1a2740">RESUMEN</td>
                        <td class="border border-[#2b2b2b] text-center" style="background:#1a2740"><span
                                class="text-slate-400 text-xs">—</span></td>
                        <td class="border border-[#2b2b2b] text-center" style="background:#1a2740"><span
                                class="text-slate-400 text-xs">20/10/2023</span></td>
                    ...
                    <tr>
                        <td class="text-xs text-slate-200 px-3 py-2 border border-[#2b2b2b] leading-snug"
                            style="background:#172337">TÍTULO DEL PROYECTO</td>
                        <td class="border border-[#2b2b2b] text-center" style="background:#172337"><span
                                class="text-slate-400 text-xs">—</span></td>
                        <td class="border border-[#2b2b2b] text-center" style="background:#172337"><span
                                class="text-slate-400 text-xs">7/08/2023</span></td>
                        <td class="border border-[#2b2b2b] text-center" style="background:#172337"><span
                                class="text-slate-400 text-xs">7/08/2023</span></td>
                        <td class="border border-[#2b2b2b] text-center" style="background:#172337"><span
                                class="inline-block w-3.5 h-3.5 rounded-sm bg-blue-700/80 border border-blue-600/40"></span>
                    ...
                    <tr>
                        <td rowspan="12"
                            class="text-emerald-400 font-bold text-[10px] tracking-[2px] text-center px-1.5 border-r-2 border-r-emerald-500/30 border border-[#2b2b2b] align-middle select-none"
                            style="writing-mode:vertical-rl;text-orientation:mixed;transform:rotate(180deg);font-family:Syne,sans-serif;background:#0e1a2d">
                            CONSTRUCCIÓN DEL SOFTWARE</td>
                        <td class="text-xs text-slate-200 px-3 py-2 border border-[#2b2b2b] leading-snug"
                            style="background:#1a2740">1. LEVANTAMIENTO DE INFORMACIÓN</td>
                        <td class="border border-[#2b2b2b] text-center" style="background:#1a2740"><span
                                class="text-slate-400 text-xs">—</span></td>
                        <td class="border border-[#2b2b2b] text-center" style="background:#1a2740"><span
                                class="text-slate-400 text-xs">5/9/2023</span></td>
                        <td class="border border-[#2b2b2b] text-center" style="background:#1a2740"><span
                                class="text-slate-400 text-xs">5/9/2023</span></td>
                        <td class="border border-[#2b2b2b] text-center" style="background:#1a2740"><span
                                class="inline-block w-3.5 h-3.5 rounded-sm bg-blue-700/80 border border-blue-600/40"></span>
                    ...
                    <tr>
                        <td class="text-xs text-slate-200 px-3 py-2 border border-[#2b2b2b] leading-snug"
                            style="background:#172337">2. ANÁLISIS DE REQUERIMIENTOS</td>
                        <td class="border border-[#2b2b2b] text-center" style="background:#172337"><span
                                class="text-slate-400 text-xs">—</span></td>
                        <td class="border border-[#2b2b2b] text-center" style="background:#172337"><span
                                class="text-slate-400 text-xs">6/07/2024</span></td>
                        <td class="border border-[#2b2b2b] text-center" style="background:#172337"><span
                                class="text-slate-400 text-xs">28/08/2024</span></td>
                        <td class="border border-[#2b2b2b] text-center" style="background:#172337"><span
                                class="inline-block w-3.5 h-3.5 rounded-sm bg-emerald-500/60 border border-emerald-400/30"></span>
                        </td>
                    </tr>
                    <tr>
                        <td class="text-xs text-slate-200 px-3 py-2 border border-[#2b2b2b] leading-snug"
                            style="background:#1a2740">3. DISEÑO BD / CASOS DE USO / MER / CLASES</td>
                        <td class="border border-[#2b2b2b] text-center" style="background:#1a2740"><span
                                class="text-slate-400 text-xs">—</span></td>
                        <td class="border border-[#2b2b2b] text-center" style="background:#1a2740"><span
                                class="text-slate-400 text-xs">6/07/2024</span></td>
                    ...
                    <tr>
                        <td class="text-xs text-slate-200 px-3 py-2 border border-[#2b2b2b] leading-snug"
                            style="background:#172337">4. DISEÑO INTERFAZ CRUD</td>
                        <td class="border border-[#2b2b2b] text-center" style="background:#172337"><span
                                class="text-slate-400 text-xs">—</span></td>
                        <td class="border border-[#2b2b2b] text-center" style="background:#172337"><span
                                class="text-slate-400 text-xs">—</span></td>
                    ...
                    <tr>
                        <td class="text-xs text-slate-200 px-3 py-2 border border-[#2b2b2b] leading-snug"
                            style="background:#1a2740">5. CREACIÓN Y VALIDACIÓN DE PROTOTIPO</td>
                        <td class="border border-[#2b2b2b] text-center" style="background:#1a2740"><span
                                class="text-slate-400 text-xs">—</span></td>
                        <td class="border border-[#2b2b2b] text-center" style="background:#1a2740"><span
                                class="text-slate-400 text-xs">—</span></td>
                    ...
                    <tr>
                        <td class="text-xs text-slate-200 px-3 py-2 border border-[#2b2b2b] leading-snug"
                            style="background:#172337">6. IMPLEMENTACIÓN BD Y CONSULTAS SQL</td>
                        <td class="border border-[#2b2b2b] text-center" style="background:#172337"><span
                                class="text-slate-400 text-xs">—</span></td>
                        <td class="border border-[#2b2b2b] text-center" style="background:#172337"><span
                                class="text-slate-400 text-xs">1/09/2024</span></td>
                        <td class="border border-[#2b2b2b] text-center" style="background:#172337"><span
                                class="text-slate-400 text-xs">30/10/2024</span></td>
                        <td class="border border-[#2b2b2b] text-center" style="background:#172337"><span
                                class="inline-block w-3.5 h-3.5 rounded-sm bg-emerald-500/60 border border-emerald-400/30"></span>
                        </td>
                    </tr>
                    <tr>
                        <td class="text-xs text-slate-200 px-3 py-2 border border-[#2b2b2b] leading-snug"
                            style="background:#1a2740">7. IMPLEMENTACIÓN DE LA APLICACIÓN</td>
                        <td class="border border-[#2b2b2b] text-center" style="background:#1a2740"><span
                                class="text-slate-400 text-xs">—</span></td>
                        <td class="border border-[#2b2b2b] text-center" style="background:#1a2740"><span
                                class="text-slate-400 text-xs">—</span></td>
                    ...
                    <tr>
                        <td class="text-xs text-slate-200 px-3 py-2 border border-[#2b2b2b] leading-snug"
                            style="background:#172337">8. DESARROLLO DE PRUEBAS</td>
                        <td class="border border-[#2b2b2b] text-center" style="background:#172337"><span
                                class="text-slate-400 text-xs">—</span></td>
                        <td class="border border-[#2b2b2b] text-center" style="background:#172337"><span
                                class="text-slate-400 text-xs">1/11/2024</span></td>
                        <td class="border border-[#2b2b2b] text-center" style="background:#172337"><span
                                class="text-slate-400 text-xs">15/11/2024</span></td>
                        <td class="border border-[#2b2b2b] text-center" style="background:#172337"><span
                                class="inline-block w-3.5 h-3.5 rounded-sm bg-emerald-500/60 border border-emerald-400/30"></span>
                        </td>
                    </tr>
                    <tr>
                        <td class="text-xs text-slate-200 px-3 py-2 border border-[#2b2b2b] leading-snug"
                            style="background:#1a2740">9. DEPURACIÓN DE ERRORES</td>
                        <td class="border border-[#2b2b2b] text-center" style="background:#1a2740"><span
                                class="text-slate-400 text-xs">—</span></td>
                        <td class="border border-[#2b2b2b] text-center" style="background:#1a2740"><span
                                class="text-slate-400 text-xs">—</span></td>
                    ...
                    <tr>
                        <td class="text-xs text-slate-200 px-3 py-2 border border-[#2b2b2b] leading-snug"
                            style="background:#172337">10. DOCUMENTACIÓN</td>
                        <td class="border border-[#2b2b2b] text-center" style="background:#172337"><span
                                class="text-slate-400 text-xs">—</span></td>
                        <td class="border border-[#2b2b2b] text-center" style="background:#172337"><span
                                class="text-slate-400 text-xs">20/10/2023</span></td>
                    ...
                    <tr>
                        <td class="text-xs text-slate-200 px-3 py-2 border border-[#2b2b2b] leading-snug"
                            style="background:#1a2740">11. MANUAL DE USUARIO</td>
                        <td class="border border-[#2b2b2b] text-center" style="background:#1a2740"><span
                                class="text-slate-400 text-xs">—</span></td>
                        <td class="border border-[#2b2b2b] text-center" style="background:#1a2740"><span
                                class="text-slate-400 text-xs">—</span></td>
                    ...
                    <tr>
                        <td class="text-xs text-slate-200 px-3 py-2 border border-[#2b2b2b] leading-snug"
                            style="background:#172337">12. CAPACITACIÓN EN EL MANEJO</td>
                        <td class="border border-[#2b2b2b] text-center" style="background:#172337"><span
                                class="text-slate-400 text-xs">—</span></td>
                        <td class="border border-[#2b2b2b] text-center" style="background:#172337"><span
                                class="text-slate-400 text-xs">15/11/2024</span></td>
                        <td class="border border-[#2b2b2b] text-center" style="background:#172337"><span
                                class="text-slate-400 text-xs">30/11/2024</span></td>
                        <td class="border border-[#2b2b2b] text-center" style="background:#172337"><span
                                class="inline-block w-3.5 h-3.5 rounded-sm bg-blue-700/80 border border-blue-600/40"></span>
                        </td>
                    </tr>
    ...
    <!-- MODAL DE EDICIÓN -->
    <div x-show="modalEditarAbierto" @click.away="modalEditarAbierto = false; document.body.style.overflow = ''; "
        x-transition.opacity @close-modal.window="modalEditarAbierto = false"
    ...
    <form action="{{ route('projects.destroy', $project->id) }}" method="POST">
        ...
        <div x-show="modalEliminarAbierto"
            @click.away="modalEliminarAbierto = false; document.body.style.overflow = ''; " x-transition.opacity
            class="fixed inset-0 bg-black/70 backdrop-blur-sm z-50 flex items-center justify-center" x-cloak>
