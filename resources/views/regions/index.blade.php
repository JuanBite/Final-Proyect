            ...
            <div class="flex items-center gap-2 flex-wrap">
                ...
                <div class="flex gap-1.5">
                    <template x-for="t in tabs" :key="t.key">
                        <button @click="window.location.href='?tab=' + t.key " :class="tab===t.key
            ...
            <table class="w-full border-collapse min-w-[600px]">
                ...
                <tbody>
                    ...
                    <tr class="border-b border-white/5 hover:bg-emerald-500/5">
                        ...
                        <td class="px-5 py-3.5 text-center">
                            <div class="flex justify-center gap-2">
                                ...
                                {{-- EDIT --}}
                                <button @click='openModal("edit", @json($region))'
                                ...
                                <form method="POST" action="{{ route('regions.destroy', $region->id) }}">
                                    @csrf
                                    @method('DELETE')
                                    <button class="w-8 h-8 rounded-lg bg-slate-600 border border-emerald-500/15
                                               flex items-center justify-center text-slate-400
                    ...
                    <tr class="border-b border-white/5 hover:bg-emerald-500/5 transition-colors">
                        ...
                        flex items-center justify-center font-black text-xs text-slate-900">
                        ...
                        {{-- Código --}}
                        <td class="px-5 py-3.5">
                            <span class="text-xs font-mono bg-slate-800 px-2 py-1 rounded border border-white/10">
                                {{ $center->code }}
                            </span>
                        </td>
                     ...
                     bg-white/5 text-slate-300 border border-white/10">
                        ...
                        <td class="px-5 py-3.5 text-center">
                            <div class="flex justify-center gap-2">
                                ...
                                {{-- Edit --}}
                                <button @click='openModal("edit", @json($center))'
                                    class="w-8 h-8 rounded-lg bg-slate-600 border border-emerald-500/15
                                               flex items-center justify-center text-slate-400
                                               hover:bg-emerald-500/20 hover:text-emerald-400 transition-all cursor-pointer">
                                    <svg class="w-3.5 h-3.5" fill="none" stroke="currentColor" stroke-width="2"
                     ...
                     bg-white/5 text-slate-300 border border-white/10">
                        ...
                        <td class="px-5 py-3.5 text-center">
                            <div class="flex justify-center gap-2">
                                ...
                                <button @click='openModal("edit", @json($cohort))'
                                    class="w-8 h-8 rounded-lg bg-slate-600 border border-emerald-500/15
                                               flex items-center justify-center text-slate-400
                                               hover:bg-emerald-500/20 hover:text-emerald-400 transition-all cursor-pointer">
                                    <svg class="w-3.5 h-3.5" fill="none" stroke="currentColor" stroke-width="2"
                                ...
                                {{-- Delete --}}
                                <form method="POST" action="{{ route('cohorts.destroy', $cohort->id) }}">
                                    @csrf
                                    @method('DELETE')
                                    <button class="w-8 h-8 rounded-lg bg-slate-600 border border-emerald-500/15
                                               flex items-center justify-center text-slate-400
