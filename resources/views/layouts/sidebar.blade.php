<aside id="sidebar" class="fixed h-full z-50 flex flex-col bg-[#111D30] border-r border-[#00C853]/15 w-16 transition-all duration-200">
    ...
    <div id="sidebar-header" class="border-b border-[#00C853]/15 flex items-center min-h-[72px] px-0 justify-center">
        ...
        <div id="logo-open" class="w-full px-4 items-center justify-between" style="display:none">
            ...
            <button onclick="toggleSidebar()" class="w-8 h-8 flex items-center justify-center rounded-lg text-[#8AAABB] hover:bg-[#00C853]/10 hover:text-[#00C853]">
    ...
    <nav class="flex-1 px-3 py-5 flex flex-col gap-1 overflow-hidden">
        ...
        <span id="label-principal" class="hidden text-[9px] tracking-[2px] uppercase text-[#8AAABB] px-2 py-1 mt-2">Principal</span>

        <a href="{{ url('dashboard') }}" class="sidebar-link flex items-center gap-3 px-0 justify-center py-2.5 rounded-xl text-[13.5px] border transition-all
            ...
            <span class="sidebar-text hidden whitespace-nowrap">Inicio</span>
        </a>

        <a href="{{ url('projects') }}" class="sidebar-link flex items-center gap-3 px-0 justify-center py-2.5 rounded-xl text-[13.5px] border transition-all
        ...
        {{ request()->is('gestion*') ? 'text-[#00C853] bg-[#00C853]/12 border-[#00C853]/25' : 'text-[#8AAABB] border-transparent hover:bg-[#00C853]/6 hover:text-[#E8F4FF] hover:border-[#00C853]/15' }}">
            ...
            <span class="sidebar-text hidden whitespace-nowrap">Gestión</span>
        </a>
