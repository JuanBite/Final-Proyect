...
class ProjectSeeder extends Seeder
{
    public function run(): void
    {
        ...
        $project->start_date = '2024-03-01 09:00:00';
        $project->due_date = '2024-04-30 23:59:59';
        $project->progress = 75.50;
        $project->leader_id = 3; // Carlos Rodríguez (instructor)
        ...
        $project->start_date = '2024-03-15 09:00:00';
        $project->due_date = '2024-05-15 23:59:59';
        $project->progress = 45.00;
        $project->leader_id = 4; // Ana Martínez (instructor)
        $project->status = 'IN_PROGRESS';
        $project->save();
        ...
        $project->start_date = '2024-02-01 09:00:00';
        $project->due_date = '2024-03-31 23:59:59';
        $project->progress = 100.00;
        $project->leader_id = 5; // Luis Sánchez (instructor)
        ...
        $project->start_date = '2024-03-20 09:00:00';
        $project->due_date = '2024-05-20 23:59:59';
        ...
        $project->start_date = '2024-01-10 09:00:00';
        $project->due_date = '2024-04-10 23:59:59';
        $project->progress = 100.00;
        $project->leader_id = 6; // Patricia López (instructor)
        $project->status = 'COMPLETED';
        $project->save();
        ...
        $project->start_date = '2024-03-25 09:00:00';
        $project->due_date = '2024-06-25 23:59:59';
        ...
        $project->start_date = '2024-04-01 09:00:00';
        $project->due_date = '2024-07-01 23:59:59';
        $project->progress = 10.00;
        $project->leader_id = 7; // Roberto Fernández (instructor)
        $project->status = 'IN_PROGRESS';
        $project->save();
        ...
        $project->start_date = '2024-03-10 09:00:00';
        $project->due_date = '2024-05-10 23:59:59';
